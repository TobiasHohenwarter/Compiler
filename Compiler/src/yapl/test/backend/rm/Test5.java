...
public class Test5 {
	 ...
	 * 
	 * @param destReg
	 *            destination register receiving a[i].
	 * @param baseReg
	 *            register holding base address of array a.
	 * @param idxReg
	 *            register holding element index i.
	 */
	 ...
	 * 
	 * @param valueReg
	 *            register holding value to store.
	 * @param baseReg
	 *            register holding base address of array a.
	 * @param idxReg
	 *            register holding element index i (will be modified).
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		// tmp = a[i]
		backend.loadWord(r1, backend.paramOffset(0), false); // load base
																// address of a
		...
		backend.loadWord(r1, backend.paramOffset(0), false); // load base
																// address of a
		backend.loadWord(r2, backend.paramOffset(1), false); // load i
		backend.loadWord(r3, backend.paramOffset(0), false); // load base
																// address of a
